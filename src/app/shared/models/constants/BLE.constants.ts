...
export class BLEConstants {
  public static readonly GenericAccessService: Service =
    {
  ...
  public static readonly GenericAttributeService: Service =
    {
  ...
  public static readonly DeviceInformationService: Service =
    {
  ...
  public static readonly FirmwareService: Service =
    {
  ...
  public static readonly AlertNotificationService: Service =
    {
  ...
  public static readonly ImmediateAlertService: Service =
    {
  ...
  public static readonly HeartRateService: Service =
    {
  ...
  public static readonly MiBandService: Service =
    {
  ...
  public static readonly AuthenticationService: Service =
    {
